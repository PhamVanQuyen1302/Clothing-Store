            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <button type="button" class="btn" id="page-header-user-dropdown"
                    ...
                    <span class="d-flex align-items-center">
                        <img class="rounded-circle header-profile-user" src="../../public/admin/assets/images/profile-bg.jpg"
                            alt="Header Avatar">
                        <span class="text-start ms-xl-2">
                            <span
                                class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">dsadsadsa</span>
