                                ...
                                <div>
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                        id="create-btn" data-bs-target="#showModal"><i
                                            ...
                                            href="{{ route('admin.payments.create') }}">Thêm</a></button>
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <a href="{{ route('admin.payments.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                                <a href="{{ route('admin.payments.destroy', $item->id) }}"
