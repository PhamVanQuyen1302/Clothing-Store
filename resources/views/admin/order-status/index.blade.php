                                ...
                                <div>
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                        id="create-btn" data-bs-target="#showModal"><i
                                            ...
                                            href="{{ route('admin.order-status.create') }}">Thêm</a></button>
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <a href="{{ route('admin.order-status.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                                <a href="{{ route('admin.order-status.destroy', $item->id) }}"
